    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('episodeinfo_episode_type', models.CharField(blank=True, max_length=200, null=True)),
                ...
                ('episodeinfo_sub_title', models.CharField(blank=True, max_length=150, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('listingitem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='metadata_embedded', to='services_listing.ListingItem')),
                ('metadata', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='metadata_embedded.EmbeddedInfo')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='metadata_embedded', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
