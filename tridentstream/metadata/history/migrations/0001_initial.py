    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('history', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='metadata_history.History')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('listingitem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='metadata_history', to='services_listing.ListingItem')),
                ('metadata', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='metadata_history.HistoryMetadata')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='metadata_history', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
