...
def log_user_login_failed(sender, credentials, request, **kwargs):
    try:
        ...
        logger.debug('Unknown user %s tried to login' % (credentials.get('username', None), ))
        return
...
def register_signals():
    ...
    user_login_failed.connect(log_user_login_failed, dispatch_uid='log_user_login_failed')
